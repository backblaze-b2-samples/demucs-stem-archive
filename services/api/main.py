...
from app.runtime import files, health, metrics, tracks  # noqa: E402
...
app = FastAPI(
    title="Demucs Stem Archive API",
    description="Audio stem-separation archive backed by Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
